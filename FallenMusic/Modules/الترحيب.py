...
from FallenMusic.filters import command ChatMemberUpdated, InlineKeyboardMarkup, InlineKeyboardButton
...
async def WelcomeDev(_, response: ChatMemberUpdated):
    dev_id = 6975380739 # حط ايديك هنا
    if response.from_user.id == dev_id:
        ...
        await app.send_photo(
            ...
            caption=f"- لقد انضم مطور السورس هنا ♥️✨. {name} دخل الشات.\n- {bio}"
        )
